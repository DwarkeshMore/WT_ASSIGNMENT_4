<!DOCTYPE html>
    ...
    <body>
        <div class="jumbotron text-center"><h1 style="color: red;">WELCOME TO THE RESTAURENT</h1></div>
       

        <div class="cont">
            <h1>Place a dish order</h1>
          </div>
        ...
        <footer>
            <!-- <div class="footer1">
                <div class="container-fluid"> -->
                    ...
                    <a href="mailto:dpmore@mitaoe.ac.in">dpmore@mitaoe.ac.in</a></p>
                    <!-- </div>
              </div> -->
        </footer>
        ...
        function getRestaurantMenuList() {
            ...
            function getMenuItemList(i)
            {
                ...
                $.get(url,function(data,success){
                        ...
                        if(descrp == ""){
                            descrp = "Description is not available for the dish";
                        }
